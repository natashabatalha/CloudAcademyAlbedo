...
c !!! Extrapolation lineaire pour T<1400K
 ...
 2000 format((1x,1p8d10.3))
      ...
      if (init) then
       init=.false.
       write(*,100)
 100   format(1x,'Table des absorptions H2- free-free d''apres Bell')
...
c     Version: 04/01/95
     ...
     &     llx,lly,ix,iy,sx,sy,nrx,nry
      ...
      double precision x(1),y(1),f(1),xt(1),yt(1),s(1),xr(1),yr(1),
...
c     Version: 04/01/95
     ...
     &     llx,lly,ix,iy,sx,sy,nrx,nry
      ...
      double precision x(1),y(1),f(1),xt(1),yt(1),s(1),xx,yy,fxy,dfxydx,dfxydy,
     &     ax(dimaxy),ay(dimaxy),qx(dimqxy),qy(dimqxy),dx(dimdxy),
...
c     Auteur: P. Morel, Departement J.D. Cassini, O.C.A., Observatoire de Nice
      ...
      double precision x(1),y(1),mm1,eps
      data eps/1.d-12/
...
c     sff_hm: coefficient d'absorption [cm2]
      ...
      implicit none
      double precision sigma,sff_hm,al,aj1(6),bj1(6),cj1(6),dj1(6),ej1(6),
     !       fj1(6),aj2(6),bj2(6),cj2(6),dj2(6),ej2(6),fj2(6),t,tcoeff,
     !       hj(6)
